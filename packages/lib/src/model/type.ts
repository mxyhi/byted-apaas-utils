...
export type SortCond<T extends ObjectApiNames> = Partial<Record<keyof metadataMap[T], 1 | -1>>;

export type ResultData<T extends ObjectApiNames, K extends keyof metadataMap[T]> = Pick<
  metadataMap[T],
  K
>;
...
export type CreateRecordMap<T extends ObjectApiNames> = PartialKey<metadataMap[T], "_id">;
